...
import { Home as HomeIcon, Settings, CreditCard, LogOut, BarChart } from 'lucide-react';
...
export default function Home() {
  ...
  const links = [
    ...
    { label: 'Analytics', href: '/analytics', icon: <BarChart className="text-neutral-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" /> },
